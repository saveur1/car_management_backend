export const StaffDoc = {
  ...
  "/api/v1/staff/permissions": {
    put: {
      ...
      summary: "Update permissions for staff members by position",
      description: "Updates the permissions for all staff members with the specified position.",
      requestBody: {
        content: {
          "application/json": {
            schema: {
              ...
              properties: {
                position: {
                  type: "string",
                  description: "Position of the staff to update",
                  example: "manager",
                  required: true,
                },
                allowDelete: {
              ...
              required: ["position", "allowDelete", "allowEdit", "allowAdd"],
            },
          },
        },
      },
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  ...
                  message: {
                    type: "string",
                    example: "All staffs with given position were successfully updated",
                  },
                },
              },
            },
